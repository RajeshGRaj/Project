...
public class ChatPage extends Base_Class {
	...
	public void clickAll() {
		try {
			click(L_all);
			ExtentTestManager.getTest().log(Status.FAIL, "All Tab Clicked");
		} catch (Exception e) {
	...
	public void clickClose() {
		try {
			click(L_close);
			ExtentTestManager.getTest().log(Status.FAIL, "Closed Button Clicked");
		} catch (Exception e) {
	...
	public void clickMissed() {
		try {
			click(L_missed);
			ExtentTestManager.getTest().log(Status.FAIL, "Missed Button Clicked");
		} catch (Exception e) {
	...
	public void clickEscalate() {
		try {
			click(L_missed);
			ExtentTestManager.getTest().log(Status.FAIL, "Escalated Button Clicked");
		} catch (Exception e) {
