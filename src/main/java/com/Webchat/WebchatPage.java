...
public class WebchatPage extends Base_Class {
	...
	//Locators
	public By L_message = By.xpath("(//div[@class='normal-msg ng-tns-c3437153413-0 ng-star-inserted'])[1]");
	...
	public By L_wrapbox = By.xpath("//div[contains(@class,'chat__terms-popup')]//span[.='Accept Terms and Conditions ']");
